#Function to clean pregnancy(Type O) excel sheets & copy them to SQLite database
def pregnancy(sheetname):    
    import numpy as np
    import pandas as pd
    ...
    #changing name of column 'z ZB' to 'Category'
    dfo.rename({'z ZB': 'Category'}, axis=1,inplace=True)
